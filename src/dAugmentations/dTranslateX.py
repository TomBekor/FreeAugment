...
class DTranslateX(
    ...
    def __init__(
        ...
        super(DTranslateX, self).__init__()
        self.daug_param_init(
            "TranslateX", low_m, high_m, det_m, learnable_app_prob, device
        )
        ...
        self.mult_factor = DAugmentation.image_size[0]
    ...
    def forward(self, input, augmented_idxs=None):
        ...
        translation = torch.vstack([m, zero_translate]).T
